              ...
              @foreach ($todos as $todo)
                @if (!$todo->completed)
                  <li class="list-group-item">
                    ...
                    <br>
                    <span
                      style="font-size: 0.75rem;">Created at: {{ date('d M Y h:i a', strtotime($todo->created_at)) }}</span>
              ...
              @foreach ($todos as $todo)
                @if ($todo->completed)
                  <li class="list-group-item">
                    ...
                    <br>
                    <span
                      style="font-size: 0.75rem;">Updated at: {{ date('d M Y h:i a', strtotime($todo->updated_at)) }}</span>
